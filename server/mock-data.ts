...
export const defaultMenuItems: Omit<MenuItem, 'id'>[] = [
  {
    ...
    price: 15000,
    category: "seblak",
    image: "https://images.unsplash.com/photo-1625869016774-3a92be2ae2cd?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300",
    spicyLevel: "Pedas",
    stockQuantity: 25,
    lowStockThreshold: 5,
    unit: "porsi",
  ...
  },
  {
    ...
    price: 25000,
    category: "seblak",
    image: "https://images.unsplash.com/photo-1563379926898-05f4575a45d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300",
    spicyLevel: "Spesial",
    stockQuantity: 15,
    lowStockThreshold: 3,
    unit: "porsi",
